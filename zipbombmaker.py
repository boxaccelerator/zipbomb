...
if __name__ == '__main__':
	...
	end_time = time.time()
	print 'Compressed File Size: %.4f B'%(get_file_size(out_zip_file)/1024.0/1024.0)
	print 'Size After Decompression: %.4f B'%(decompressed_size/1024.0/1024.0/1024.0)
	print 'Generation Time: %.4fs'%(end_time - start_time)
